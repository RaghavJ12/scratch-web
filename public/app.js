...
;// CONCATENATED MODULE: ./src/constants/blocks.js
var blocks = {
  Control: [{
    text: 'Wait for ^val',
    val: true
...
/* harmony default export */ var constants_blocks = (blocks);
...
;// CONCATENATED MODULE: ./src/redux/actionTypes.js
var actionTypes_actionTypes = Object.freeze({
  ADD_TAB: 'ADD_TAB',
...
/* harmony default export */ var redux_actionTypes = (actionTypes_actionTypes);
;// CONCATENATED MODULE: ./src/redux/action.js

var appendTab = function appendTab() {
  return {
    type: redux_actionTypes.ADD_TAB
  };
};
var removeTab = function removeTab(tabId) {
  return {
    type: redux_actionTypes.REMOVE_TAB,
    payload: tabId
  };
};
var switchTab = function switchTab(tabId) {
  return {
    type: redux_actionTypes.SWITCH_TAB,
    payload: tabId
  };
};
var addCommand = function addCommand(sprite, cmdID, cmdText, cmdVal) {
  return {
    type: redux_actionTypes.ADD_CMD,
    payload: {
      sprite: sprite,
      cmd: {
        cmdID: cmdID,
...
var removeCommand = function removeCommand(sprite, cmdId) {
  return {
...
;// CONCATENATED MODULE: ./node_modules/react-hot-toast/dist/react-hot-toast.esm.js



function react_hot_toast_esm_extends() {
  react_hot_toast_esm_extends = Object.assign || function (target) {
  ...
  return react_hot_toast_esm_extends.apply(this, arguments);
}
...
var reducer = function reducer(state, action) {
  switch (action.type) {
    case ActionType.ADD_TOAST:
      return react_hot_toast_esm_extends({}, state, {
    ...
    case ActionType.UPDATE_TOAST:
      ...
      return react_hot_toast_esm_extends({}, state, {
        toasts: state.toasts.map(function (t) {
          return t.id === action.toast.id ? react_hot_toast_esm_extends({}, t, action.toast) : t;
        })
      });
    ...
    case ActionType.DISMISS_TOAST:
      ...
      return react_hot_toast_esm_extends({}, state, {
        toasts: state.toasts.map(function (t) {
          return t.id === toastId || toastId === undefined ? react_hot_toast_esm_extends({}, t, {
            visible: false
          }) : t;
        })
      });
    ...
    case ActionType.END_PAUSE:
      ...
      return react_hot_toast_esm_extends({}, state, {
        pausedAt: undefined,
        toasts: state.toasts.map(function (t) {
          return react_hot_toast_esm_extends({}, t, {
...
var useStore = function useStore(toastOptions) {
  ...
  var _useState = (0,react.useState)(memoryState),
      state = _useState[0],
  ...
  var mergedToasts = state.toasts.map(function (t) {
    ...
    return react_hot_toast_esm_extends({}, toastOptions, toastOptions[t.type], t, {
      duration: t.duration || ((_toastOptions$t$type = toastOptions[t.type]) == null ? void 0 : _toastOptions$t$type.duration) || ((_toastOptions = toastOptions) == null ? void 0 : _toastOptions.duration) || defaultTimeouts[t.type],
      style: react_hot_toast_esm_extends({}, toastOptions.style, (_toastOptions$t$type2 = toastOptions[t.type]) == null ? void 0 : _toastOptions$t$type2.style, t.style)
    });
  });
  return react_hot_toast_esm_extends({}, state, {
    toasts: mergedToasts
...
var createToast = function createToast(message, type, opts) {
  ...
  return react_hot_toast_esm_extends({
    createdAt: Date.now(),
    visible: true,
    type: type,
    ariaProps: {
...
toast.promise = function (promise, msgs, opts) {
  var id = toast.loading(msgs.loading, react_hot_toast_esm_extends({}, opts, opts == null ? void 0 : opts.loading));
  promise.then(function (p) {
    toast.success(resolveValue(msgs.success, p), react_hot_toast_esm_extends({
      id: id
    }, opts, opts == null ? void 0 : opts.success));
    return p;
  })["catch"](function (e) {
    toast.error(resolveValue(msgs.error, e), react_hot_toast_esm_extends({
      id: id
...
var ToastIcon = function ToastIcon(_ref) {
  ...
  if (icon !== undefined) {
    if (typeof icon === 'string') {
      return (0,react.createElement)(AnimatedIconWrapper, null, icon);
    } else {
      return icon;
    }
  }
  ...
  return (0,react.createElement)(IndicatorWrapper, null, (0,react.createElement)(LoaderIcon, Object.assign({}, iconTheme)), type !== 'loading' && (0,react.createElement)(StatusWrapper, null, type === 'error' ? (0,react.createElement)(ErrorIcon, Object.assign({}, iconTheme)) : (0,react.createElement)(CheckmarkIcon, Object.assign({}, iconTheme))));
};
...
var ToastBar = /*#__PURE__*/(0,react.memo)(function (_ref2) {
  ...
  var icon = (0,react.createElement)(ToastIcon, {
    toast: toast
  });
  var message = (0,react.createElement)(Message, Object.assign({}, toast.ariaProps), resolveValue(toast.message, toast));
  return (0,react.createElement)(ToastBarBase, {
    className: toast.className,
    style: react_hot_toast_esm_extends({}, animationStyle, style, toast.style)
  }, typeof children === 'function' ? children({
    icon: icon,
    message: message
  }) : (0,react.createElement)(react.Fragment, null, icon, message));
});
...
var Toaster = function Toaster(_ref) {
  ...
  return (0,react.createElement)("div", {
    style: react_hot_toast_esm_extends({
      position: 'fixed',
      zIndex: 9999,
      top: DEFAULT_OFFSET,
      left: DEFAULT_OFFSET,
    ...
    return (0,react.createElement)("div", {
      ...
      key: t.id,
      style: positionStyle
    }, t.type === 'custom' ? resolveValue(t.message, t) : children ? children(t) : (0,react.createElement)(ToastBar, {
      toast: t,
...
/* harmony default export */ var react_hot_toast_esm = (toast);
...
var reducer_reducer = function reducer() {
  ...
  switch (action.type) {
    case redux_actionTypes.ADD_TAB:
      return reducer_objectSpread(reducer_objectSpread({}, state), {}, {
        tabs: [].concat(_toConsumableArray(state.tabs), ["S".concat(state.tabCount + 1)]),
        currentTab: "S".concat(state.tabCount + 1),
        tabCount: state.tabCount + 1
      });

    case redux_actionTypes.REMOVE_TAB:
      ...
      var filteredTab = state.tabs.filter(function (tabId) {
        return tabId !== action.payload;
      }); // Check if currentTab is removed or not

      var currTabIndex = filteredTab.indexOf(state.currentTab); // If current is removed, make the previous one current
      ...
      return reducer_objectSpread(reducer_objectSpread({}, state), {}, {
        tabs: _toConsumableArray(filteredTab),
        currentTab: filteredTab[currTabIndex],
        commands: reducer_objectSpread({}, cmds)
      });

    case redux_actionTypes.SWITCH_TAB:
      return reducer_objectSpread(reducer_objectSpread({}, state), {}, {
        currentTab: action.payload
      });

    case redux_actionTypes.ADD_CMD:
      var sprite = action.payload.sprite;
      var cmd = action.payload.cmd;
      if (!state.commands[sprite]) state.commands[sprite] = [];
      var newSpriteCmds = state.commands[sprite];
      newSpriteCmds.push(cmd);
      return reducer_objectSpread(reducer_objectSpread({}, state), {}, {
        commands: reducer_objectSpread(reducer_objectSpread({}, state.commands), {}, _defineProperty({}, sprite, _toConsumableArray(newSpriteCmds)))
      });

    case redux_actionTypes.REMOVE_CMD:
      return reducer_objectSpread(reducer_objectSpread({}, state), {}, {
        commands: reducer_objectSpread(reducer_objectSpread({}, commands), {}, _defineProperty({}, action.payload.sprite, action.payload.cmd))
      });
...
/* harmony default export */ var redux_reducer = (reducer_reducer);
;// CONCATENATED MODULE: ./src/redux/store.js


var middlewares = (/* unused pure expression or super */ null && ([]));
var composeEnhancers = window.__REDUX_DEVTOOLS_EXTENSION__ ? window.__REDUX_DEVTOOLS_EXTENSION__() : compose;
var store = createStore(redux_reducer, composeEnhancers);
...
function drop(ev) {
  ev.preventDefault();
  var id = ev.dataTransfer.getData('dragId');
  var v = ev.dataTransfer.getData('dragVal'); // console.log("pass",v);
  ...
  var sprite = redux_store.getState().currentTab;
  redux_store.dispatch(addCommand(sprite, nodeCopy.id, nodeCopy.textContent, nodeCopy.val));
...
function deleteSprite(ev) {
  var id = ev.dataTransfer.getData('dragId');
  if (!id.startsWith('sprite')) return;
  redux_store.dispatch(removeTab(id.split('-')[1]));
}
;// CONCATENATED MODULE: ./src/utils/getBlockColor.js
var getBlockColor = function getBlockColor(blockName) {
  switch (blockName) {
    case 'Control':
      return 'red';
...
/* harmony default export */ var utils_getBlockColor = (getBlockColor);
...
;// CONCATENATED MODULE: ./src/utils/stringFormatter.js
var getTextIcon = function getTextIcon(data, loc) {
  var _data$text;

  var hasIcon = data === null || data === void 0 ? void 0 : data.icon;
  var text = hasIcon ? data === null || data === void 0 ? void 0 : (_data$text = data.text) === null || _data$text === void 0 ? void 0 : _data$text.split('#icon') : data === null || data === void 0 ? void 0 : data.text;

  if (loc === 0) {
    return hasIcon ? text[0] : text;
  } else if (loc === 1) {
    return hasIcon ? data === null || data === void 0 ? void 0 : data.icon : null;
  } else {
    var _text$;

    return hasIcon ? (_text$ = text[1]) === null || _text$ === void 0 ? void 0 : _text$.replace('^val ', '') : '';
  }
};
...
var InputNum = function InputNum() {
  ...
  console.log(val);
  return [/*#__PURE__*/React.createElement(NumericInput, {
    value: val,
    onValueChange: setVal,
    className: "w-12 form-control rounded text-black mx-3"
  }), val];
};
;// CONCATENATED MODULE: ./src/components/BlockWrapper.js
...
function BlockWrapper(_ref) {
  ...
  if (text.includes('$')) {
    ...
    var toHide = splittedText.pop();
    JSXText = /*#__PURE__*/react.createElement(react.Fragment, null, splittedText.join(''), /*#__PURE__*/react.createElement("span", {
      className: "hidden"
    }, toHide));
    return JSXText;
  } else if (text.includes('^')) {
    var _splittedText = text.split('^val');

    JSXText = /*#__PURE__*/react.createElement(react.Fragment, null, _splittedText[0], _splittedText[1]);
    return JSXText;
  }
...
/* harmony default export */ var components_BlockWrapper = (BlockWrapper);
;// CONCATENATED MODULE: ./node_modules/react-typed-inputs/dist-web/index.js


function clamp(x, lower = Number.NEGATIVE_INFINITY, upper = Number.POSITIVE_INFINITY) {
...
function toInner(value) {
    return value != null ? String(value) : '';
}
function toOuter(value) {
    return value ? Number(value) : null;
}
const dist_web_NumericInput = (0,react.forwardRef)(({ value, min, max, step = 1, clampAfterBlur, roundAfterBlur, onValueChange, onChange, onBlur, ...props }, ref) => {
    const [innerValue, setInnerValue] = (0,react.useState)(toInner(value));
    ...
    function handleEvent(baseCallack, event, nextInnerValue, transformValue) {
    ...
    return ((0,react.createElement)("input", Object.assign({ ref: ref, pattern: inputMode === 'numeric' ? '\\d*' : undefined, inputMode: inputMode, value: value !== undefined ? innerValue : value, min: min, max: max, step: step, onChange: (event) => {
...
;// CONCATENATED MODULE: ./src/components/SidebarItem.js
...
var SidebarItem = function SidebarItem(_ref) {
  ...
  var _useState = (0,react.useState)([10, 10, 10, 10, 10, 10]),
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("div", {
  ...
  }, " ", title, " "), data.map(function (_d, i) {
    return /*#__PURE__*/react.createElement("div", {
      draggable: true,
      onDragStart: drag,
      id: title + i,
      key: title + i,
      className: "".concat(val[i], " flex flex-row flex-wrap bg-").concat(utils_getBlockColor(title), "-500 text-white px-2 py-1 my-2 text-sm cursor-pointer rounded-lg w-full text-base justify-center")
    }, /*#__PURE__*/react.createElement(components_BlockWrapper, {
      text: getTextIcon(_d, 0),
      icon: _d !== null && _d !== void 0 && _d.icon ? "true" : "false"
    }), getTextIcon(_d, 1) && /*#__PURE__*/react.createElement(Icon, {
      name: getTextIcon(_d, 1),
      size: 15,
      className: "text-green-600 mx-2"
    }), _d.val ? /*#__PURE__*/react.createElement(dist_web_NumericInput, {
      value: val[i],
      onValueChange: function onValueChange(value) {
        var valCopy = _toConsumableArray(val);
    ...
    }) : null, /*#__PURE__*/react.createElement(components_BlockWrapper, {
      text: getTextIcon(_d, 2)
    }));
  }));
};
...
/* harmony default export */ var components_SidebarItem = (SidebarItem);
...
function Sidebar() {
  ...
  }, "Commands "), Object.keys(constants_blocks).map(function (blockName) {
    return /*#__PURE__*/react.createElement(components_SidebarItem, {
      key: blockName,
      title: blockName,
      data: constants_blocks[blockName]
    });
  }));
}
...
;// CONCATENATED MODULE: ./src/components/TabArea.js
...
function TabArea() {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("div", {
    ...
    return /*#__PURE__*/react.createElement("button", {
      ...
      id: 'sprite-' + tab,
      key: tab + 'btn',
      className: "".concat(tab === currentTab ? 'bg-pink-600' : 'bg-pink-400 hover:bg-pink-500', "  text-white font-semibold py-2 px-4 rounded inline-flex items-center"),
      "data-tab": tab
    }, getName(tab));
  })), /*#__PURE__*/react.createElement("div", {
    className: "h-16 border-grey-200 border-l absolute bottom-0 right-2 bg-white"
    ...
    className: "text-center bg-blue-100 py-2"
  }, "DropBox for ", getName(currentTab)));
}

/* harmony default export */ var components_TabArea = (TabArea);
...
function MidArea() {
  ...
  }, /*#__PURE__*/react.createElement(components_TabArea, null), tabs.map(function (tab) {
    return /*#__PURE__*/react.createElement("div", {
      key: tab + 'div',
      onDrop: drop,
      onDragOver: allowDrop,
      className: "flex-1 h-full overflow-auto ".concat(tab === currentTab ? 'block px-12' : 'hidden')
    });
  }));
}
...
;// CONCATENATED MODULE: ./src/utils/mergeSprite.js


var mergeSprite = function mergeSprite(commands) {
  var results = [];

  for (var sprite in commands) {
    results.push.apply(results, _toConsumableArray(commands[sprite]));
  }

  return results;
};

/* harmony default export */ var utils_mergeSprite = (mergeSprite);
;// CONCATENATED MODULE: ./src/utils/utility.js



var _marked = /*#__PURE__*/regenerator_default().mark(makeRangeIterator);

function makeRangeIterator(times) {
  var iterationCount, i;
  return regenerator_default().wrap(function makeRangeIterator$(_context) {
    while (1) {
...
var sleepFor = /*#__PURE__*/function () {
  var _ref = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(time) {
  ...
  return function sleepFor(_x) {
    return _ref.apply(this, arguments);
  };
}();
var moveCat = /*#__PURE__*/function () {
  var _ref2 = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee2(cat, val) {
    return regenerator_default().wrap(function _callee2$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            // cat.style.transform = ``;
            cat.style.transform += "translate(".concat(10 * val, "px,0%)");
  ...
  return function moveCat(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();
var jumpCat = /*#__PURE__*/function () {
  var _ref3 = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee3(cat) {
    return regenerator_default().wrap(function _callee3$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            cat.style.transform += "translateY(-100%)"; // console.log(new DOMMatrixReadOnly(cat.style.transform))
  ...
  return function jumpCat(_x4) {
    return _ref3.apply(this, arguments);
  };
}();
var turnCat = function turnCat(cat, degree, dir) {
  dir = dir === 'CW' ? 1 : -1;
  cat.style.transform += "rotate(".concat(dir * degree, "deg)");
};
var isGeneratorFunc = function isGeneratorFunc(func) {
  if (!func) return false;
  return func.constructor.name === makeRangeIterator.constructor.name;
};
;// CONCATENATED MODULE: ./src/utils/commandMapping.js




var controlCommands = /*#__PURE__*/function () {
  var _ref = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(cmd, val) {
    var splitCmd;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.t0 = splitCmd[0];
            _context.next = _context.t0 === 'Wait' ? 5 : _context.t0 === 'Repeat' ? 8 : 10;
            break;
          ...
          case 8:
            ...
            return _context.abrupt("return", makeRangeIterator(val));
  ...
  return function controlCommands(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var motionCommands = /*#__PURE__*/function () {
  var _ref2 = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee2(cmd, val) {
    var splitCmd, cat;
    return regenerator_default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            splitCmd = cmd.split(' ');
            splitCmd = splitCmd.filter(function (cmdStr) {
              return cmdStr.trim();
            });
            console.log("cmd", val);
            cat = document.querySelector('#movingCat');
            _context2.t0 = splitCmd[0];
            _context2.next = _context2.t0 === 'Move' ? 7 : _context2.t0 === 'Jump' ? 9 : _context2.t0 === 'Turn' ? 11 : 13;
            break;
  ...
  return function motionCommands(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var looksCommands = /*#__PURE__*/function () {
  var _ref3 = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee3(cmd, val) {
    var splitCmd, toastConfig;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.t0 = splitCmd[0];
            _context3.next = _context3.t0 === 'Say' ? 6 : _context3.t0 === 'Think' ? 8 : 10;
            break;

          case 6:
            react_hot_toast_esm(splitCmd[1], toastConfig);
            return _context3.abrupt("return");

          case 8:
            react_hot_toast_esm('Thinking... ' + splitCmd[1], toastConfig);
            return _context3.abrupt("return");
  ...
  return function looksCommands(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
;// CONCATENATED MODULE: ./src/utils/commandParser.js



function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = commandParser_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }

function commandParser_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return commandParser_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return commandParser_arrayLikeToArray(o, minLen); }

function commandParser_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }




var commandParser = /*#__PURE__*/function () {
  var _ref = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(commands) {
  ...
  return function commandParser(_x) {
    return _ref.apply(this, arguments);
  };
}();

var commandRepeater = /*#__PURE__*/(/* unused pure expression or super */ null && (function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(commands, gen) {
  ...
  return function commandRepeater(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}()));

var commandRunner = /*#__PURE__*/function () {
  var _ref3 = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee3(cmd) {
    return regenerator_default().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            if (!cmd.cmdID.includes('Control')) {
              _context3.next = 2;
              break;
            }

            return _context3.abrupt("return", controlCommands(cmd.cmdText, cmd.cmdVal));

          case 2:
            if (!cmd.cmdID.includes('Events')) {
              _context3.next = 4;
              break;
            }

            return _context3.abrupt("return", motionCommands(cmd.cmdText));

          case 4:
            if (!cmd.cmdID.includes('Looks')) {
              _context3.next = 6;
              break;
            }

            return _context3.abrupt("return", looksCommands(cmd.cmdText, cmd.cmdVal));

          case 6:
            if (!cmd.cmdID.includes('Motion')) {
              _context3.next = 8;
              break;
            }

            return _context3.abrupt("return", motionCommands(cmd.cmdText, cmd.cmdVal));
  ...
  return function commandRunner(_x4) {
    return _ref3.apply(this, arguments);
  };
}();

/* harmony default export */ var utils_commandParser = (commandParser);
...
function PreviewArea() {
  var bgCols = ["red", "blue", "green", "yellow", "purple", "pink"];
  var commands = useSelector(function (state) {
    return state.commands;
  });

  var _useState = (0,react.useState)("red"),
      _useState2 = slicedToArray_slicedToArray(_useState, 2),
      bgcol = _useState2[0],
      setBgcol = _useState2[1];

  var reset = function reset() {
    var cat = document.querySelector('#movingCat');
    cat.style = '';
    react_hot_toast_esm.success('Reset', {
      position: 'bottom-left'
    });
  };
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return utils_commandParser(utils_mergeSprite(commands));
  ...
  return /*#__PURE__*/react.createElement("div", {
    onClick: execute,
    className: "flex-none w-full h-full overflow-y-auto p-2 bg-".concat(bgcol, "-200")
  }, /*#__PURE__*/react.createElement("div", {
    className: "flex min-h-[50%]"
  }, /*#__PURE__*/react.createElement("button", {
    ...
    name: "flag",
    size: 20,
    className: "text-green-500 mx-3.5"
  })), /*#__PURE__*/react.createElement("button", {
    ...
    name: "redo-alt",
    size: 20,
    className: "text-red-500 mx-3.5"
  })), /*#__PURE__*/react.createElement("select", {
    value: bgcol,
    onChange: handleChange,
    className: "w-20 p-1 rounded mt-2"
  }, bgCols.map(function (col, i) {
    return /*#__PURE__*/react.createElement("option", {
      key: i
    }, col);
  }))), /*#__PURE__*/react.createElement(CatSprite, {
    id: "movingCat",
    className: "transition-all mt-60"
  }));
}
...
react_dom.render( /*#__PURE__*/react.createElement(react.StrictMode, null, /*#__PURE__*/react.createElement(components_Provider, {
  store: redux_store
}, /*#__PURE__*/react.createElement(App, null), /*#__PURE__*/react.createElement(Toaster, null))), document.getElementById('root'));
}();
/******/ })()
;